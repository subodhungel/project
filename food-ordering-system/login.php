...
if(isset($_SESSION['admin_sid']) || isset($_SESSION['resowner_sid'])){
	header("location:resowner.php");
}elseif (isset($_SESSION['customer_sid'])){
	if (isset($_GET['userstatus'])) {
		header("location:index.php?RestaurantName=$RestaurantName");
	}else {
...
<body class="cyan">
  ...
  <div class="row">
    <img src="../images/icons/homebutton.png" width="30px" style="margin-right: 5px;"><a href="../index.html"><span style="color: white; font-size: 18px;">Home</span></a></img>
  </div>
      ...
      <form method="post" action="routers/router.php" class="login-form" id="form">
        <div class="row">
          <div class="input-field col s12 center">
            <p class="center login-form-text">Login for Foodies</p>
          </div>
        </div>
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <?php
              if(isset($_GET['userstatus']))
                echo"<input name='gotoorder'  type='hidden' value='yes'>";
            ?>
