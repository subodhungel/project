      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
         ...
         <div class="col col s8 m8 l8">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Manage Menu</a>
            </li>
                <li class="no-padding">
                ...
                <?php
                  $sql = mysqli_query($con, "SELECT DISTINCT status FROM orders WHERE resowner_id = $user_id;");
            ...
            <li class="bold active"><a href="detailsofresowner.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Edit Details</a>
            </li>
        </ul>
...
<div>
                <div class="card-panel">
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/detailsofresowner-router.php" novalidate="novalidate"class="col s12">
                      <div class="row">
