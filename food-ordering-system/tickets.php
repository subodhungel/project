  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Food</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> Booking</a>
                            <div class="collapsible-body">
                                <ul>
								<li class="<?php
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">You can reserve tables according to specific time period in our restaurant</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Reserve a table</h4>
              </div>
<div>
                    ...
                    <form class="formValidate" id="formValidate" method="post" action="routers/add-ticket.php" novalidate="novalidate" class="col s12">
                      <div class="row">
                        <div class="input-field col s12">
                          <input name="subject" id="subject" type="text" value="Reservation" data-error=".errorTxt1">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <label for="description" class="">Please enter the Number of seats you want to reserve</label>
                      ...
                      <div class="row">
                        <div class="input-field col s4">
							<select name="type">
								<option disabled selected>Choose time range</option>
								<option value="10am to 1pm">10 am to 1 pm</option>
								<option value="1pm to 4pm">1 pm to 4 pm</option>
								<option value="4pm to 7pm">4 pm to 7 pm</option>
								<option value="7pm to 10pm">7pm to 10pm</option>
							</select>
							<label>Type</label>
                        </div>
                      </div>
      ...
      <!-- END CONTENT -->
	        ...
	        <!--start container-->
        <div class="container">
          <p class="caption">List of Reservations</p>
          <div class="divider"></div>
  ...
  <!-- START FOOTER -->
    ...
    $("#formValidate").validate({
        ...
        messages: {
            ...
            description: {
                required: "Provide number of seats you want to reserve",
            },
            type: {
                required: "Please specify time range",
            },
        },
        errorElement : 'div',
