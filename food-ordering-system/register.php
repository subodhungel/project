<?php
session_start();
if(isset($_SESSION['admin_sid']) || isset($_SESSION['customer_sid']) || isset($_SESSION['resowner_sid']))
{
      ...
      <form class="formValidate" id="formValidate" method="post" action="routers/register-router.php" novalidate="novalidate" class="col s12">
        ...
        <div class="row margin">
          ...
          <div class="input-field col s12">
            ...
            <input name="email" id="email" type="email" data-error=".errorTxt3">
        ...
        <div class="row margin">
          ...
          <div class="input-field col s12">
            ...
            <input name="address" id="address" type="text" data-error=".errorTxt6">
        ...
        <div class="row">
          <div class="input-field col s12">
			...
			<input type="submit"   class="btn waves-effect waves-light col s12">Register</a>
          </div>
          <div class="input-field col s12">
