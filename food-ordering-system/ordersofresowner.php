<?php
// var_dump( $_SESSION['RestaurantName'] );
// die();
                        ...
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Orders</a>
                            <div class="collapsible-body">
								...
								if(!isset($_GET['status'])){
									...
									"><a href="ordersofresowner.php">All Orders</a>
                                </li>
								<?php
                                    ...
                                    echo '<li class='.(isset($_GET['status'])?($status == $_GET['status'] ? 'active' : ''): '').'><a href="ordersofresowner.php?status='.$row['status'].'">'.$row['status'].'</a>
                                    </li>';
									}
									?>
                                </ul>
...
<div id="work-collections" class="seaction">
          ...
          //<p><strong>Restaurant Name</strong> '.$row['RestaurantName'].'</p>
                ...
                <div>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						echo '<li class="collection-item avatar">
							  ...
							  <form method="post" action="routers/edit-orders-resowner.php">
