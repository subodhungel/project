...
include 'includes/connect.php';
	...
	if($_SESSION['resowner_sid']==session_id())
	{
...
<head>
  ...
  <title>Restaurant Owner Panel</title>
            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">
                        <!--<li><a href="#" class="waves-effect waves-block waves-light"><i class="mdi-editor-attach-money"><?php echo "Remaining Balance".$balance;?></i></a>-->
                        </li>
                    </ul>
                </div>
            </nav>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
								...
								<ul class="collapsible collapsible-accordion">
										<li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Orders</a>
												<div class="collapsible-body">
														<ul>
						<li><a href="ordersofresowner.php?">All Orders</a>
														</li>
						<?php
							$sql = mysqli_query($con, "SELECT DISTINCT status FROM orders;");
							while($row = mysqli_fetch_array($sql)){
																echo '<li><a href="ordersofresowner.php?status='.$row['status'].'">'.$row['status'].'</a>
																</li>';
							}
							?>
														</ul>
                ...
                <lli class="no-padding">
									 <ul class="collapsible collapsible-accordion">
											 <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Bookings</a>
													 <div class="collapsible-body">
															 <ul>
							 <li><a href="ticketsofresowner.php">All Reservations</a>
															 </li>
							 <?php
								 $sql = mysqli_query($con, "SELECT DISTINCT status FROM tickets;");
								 while($row = mysqli_fetch_array($sql)){
																	 echo '<li><a href="ticketsofresowner.php?status='.$row['status'].'">'.$row['status'].'</a>
																	 </li>';
								 }
								 ?>
															 </ul>
            ...
            <li class="bold"><a href="detailsofresowner.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Edit Details</a>
            </li>
        </ul>
      ...
      <section id="content">
        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu-router-resowner.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Manage Menu</h4>
              </div>
              <div>
				<table id="data-table-admin" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
				<?php
				$result = mysqli_query($con, "SELECT * FROM items WHERE username = '$username'");
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/add-item-resowner.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
...
<table>
				...
				<?php
					...
					echo '<input id="price" name="price" type="text" data-error=".errorTxt02"><div class="errorTxt02"></div></td></tr>';
				?>
				<input name="RestaurantName" type="hidden" value="<?php echo $RestaurantName; ?>" >
