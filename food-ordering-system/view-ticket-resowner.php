...
<head>
  ...
  <title>Booking No. <?php echo $ticket_id.' - '. $type;?></title>
...
<div class="section">
								...
								echo '<ul id="task-card" class="collection with-header">
									<div id="card-alert" class="card cyan">
										...
										<span class="card-title white-text darken-1">Booking No. '.$ticket_id.'</span>
										<p><strong>Subject: </strong>'.$subject.'</p>
										<p><strong>Status: </strong>'.$status.'</p>
										<p><strong>Type: </strong>'.$type.'</p>
										</div>
										<div class="card-action cyan">
										<form method="post" action="routers/ticket-status-resowner.php">
								...
								while($row1 = mysqli_fetch_array($sql1)){
								  ...
								  <li class="collection-item avatar">
									  <i class="'.($role1=='RestaurantOwner' ? 'mdi-action-star-rate' : 'mdi-social-person').' cyan circle"></i>
