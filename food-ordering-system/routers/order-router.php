...
$total = $_POST['total'];
	$sql = "INSERT INTO orders (customer_id, payment_type, address, total, description,RestaurantName) VALUES ($user_id, '$payment_type', '$address', $total, '$description','$RestaurantName')";
