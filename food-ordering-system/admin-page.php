    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="admin-page.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Manage Menu</a>
            </li>
                <li class="no-padding">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th data-field="name">Item Price/Piece</th>
												<th data-field="id1">Restaurant Name</th>
                      </tr>
                    </thead>
