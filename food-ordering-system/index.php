...
include 'includes/wallet.php';
	...
	if($_SESSION['customer_sid']==session_id())
	{
		 ...
		 elseif (isset($_GET['RestaurantName'])) {
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i>Bookings</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="tickets.php">All Reservations</a>
                                </li>
								<?php
      ...
      <section id="content">
        ...
        if (isset($_SESSION['RestaurantName'])) {
          $RestaurantName = $_SESSION['RestaurantName'];
				...
				$result = mysqli_query($con, "SELECT * FROM items where RestaurantName = '$RestaurantName' AND not deleted;");
